<html>
	...
	<body>
		...
		<form action = "{{ url('submitForm') }}" method = "post" align="center">
			...
			<tr>
				<td>HOLE_PAR</td>
				<td><input type="text" Name="gameResult[hole_pair][0]" /></td>
				<td><input type="text" Name="gameResult[hole_pair][1]" /></td>
				<td><input type="text" Name="gameResult[hole_pair][2]" /></td>
				<td><input type="text" Name="gameResult[hole_pair][3]" /></td>
				<td><input type="text" Name="gameResult[hole_pair][4]" /></td>
				<td><input type="text" Name="gameResult[hole_pair][5]" /></td>
				<td><input type="text" Name="gameResult[hole_pair][6]" /></td>
				<td><input type="text" Name="gameResult[hole_pair][7]" /></td>
				<td><input type="text" Name="gameResult[hole_pair][8]" /></td>
				<td><input type="hidden" Name="gameResult[hole_pair][9]" /></td>
				<td><input type="text" Name="gameResult[hole_pair][10]" /></td>
				<td><input type="text" Name="gameResult[hole_pair][11]" /></td>
				<td><input type="text" Name="gameResult[hole_pair][12]" /></td>
				<td><input type="text" Name="gameResult[hole_pair][13]" /></td>
				<td><input type="text" Name="gameResult[hole_pair][14]" /></td>
				<td><input type="text" Name="gameResult[hole_pair][15]" /></td>
				<td><input type="text" Name="gameResult[hole_pair][16]" /></td>
				<td><input type="text" Name="gameResult[hole_pair][17]" /></td>
				<td><input type="text" Name="gameResult[hole_pair][18]" /></td>
			...
			<tr>
				...
				<td class="black"></td>
				<td class="black"></td>
				<td><input type="hidden" Name="gameResult[par3scor][9]" /></td>
				<td class="black"></td>
				<td class="black"></td>
				<td class="black"></td>
				<td class="black"></td>
				...
				<td class="black"></td>
				<td class="black"></td>
				<td><input type="hidden" Name="gameResult[par3sor][19]" /></td>
				<td><input type="hidden" Name="gameResult[par3scor][20]" /></td>
			</tr>
			<tr>
				<td>PAR4</td>
