...
@section('slider')
<div class="slider">
    <div id="coin-slider"> <a href="#"><img src="{{$asset}}images/22.jpg" width="935" height="307" alt="" /> </a> <a href="#"><img src="{{$asset}}images/13.jpg" width="935" height="307" alt="" /> </a> <a href="#"><img src="{{$asset}}images/12.jpg" width="935" height="307" alt="" /> </a> </div>
    <div class="clr"></div>
</div>
@stop
@section('maincontent')
<div class="mainbar">
    <div class="article">
      ...
      <div class="clr"></div>
      <div class="img"><img src="{{$asset}}images/41.jpg" width="177" height="213" alt="" class="fl" /></div>
    ...
    <div class="article">
      ...
      <div class="clr"></div>
      <div class="img"><img src="{{$asset}}images/42.jpg" width="177" height="213" alt="" class="fl" /></div>
      <div class="post_content">
