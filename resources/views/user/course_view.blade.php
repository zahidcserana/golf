						...
						<div class="table-responsive">
							<table class="table" id='spreadSheet'>
									...
									<tr>
										...
										<td class="numeric pink"><input readonly="readonly" value="{{$gameResult['hole_pair']['input'][0]}}" class=hole_par_out type="text" Name="gameResult[hole_pair][input][0]" /></td>
										<td class="numeric  pink"><input readonly="readonly" value="{{$gameResult['hole_pair']['input'][1]}}" class=hole_par_out type="text" Name="gameResult[hole_pair][input][1]" /></td>
										<td class="numeric  pink"><input readonly="readonly" value="{{$gameResult['hole_pair']['input'][2]}}" class=hole_par_out type="text" Name="gameResult[hole_pair][input][2]" /></td>
										<td class="numeric  pink"><input readonly="readonly" value="{{$gameResult['hole_pair']['input'][3]}}" class=hole_par_out type="text" Name="gameResult[hole_pair][input][3]" /></td>
										<td class="numeric  pink"><input readonly="readonly" value="{{$gameResult['hole_pair']['input'][4]}}" class=hole_par_out type="text" Name="gameResult[hole_pair][input][4]" /></td>
										<td class="numeric  pink"><input readonly="readonly" value="{{$gameResult['hole_pair']['input'][5]}}" class=hole_par_out type="text" Name="gameResult[hole_pair][input][5]" /></td>
										<td class="numeric  pink"><input readonly="readonly" value="{{$gameResult['hole_pair']['input'][6]}}" class=hole_par_out type="text" Name="gameResult[hole_pair][input][6]" /></td>
										<td class="numeric  pink"><input readonly="readonly" value="{{$gameResult['hole_pair']['input'][7]}}" class=hole_par_out type="text" Name="gameResult[hole_pair][input][7]" /></td>
										<td class="numeric  pink"><input readonly="readonly" value="{{$gameResult['hole_pair']['input'][8]}}" class=hole_par_out type="text" Name="gameResult[hole_pair][input][8]" /></td>

										<td><input value="{{$gameResult['hole_pair']['out_sum']}}"" id="hole_par_out_sum" readonly="readonly" Name="gameResult[hole_pair][out_sum]" /></td>

										<td class="numeric  pink"><input readonly="readonly" value="{{$gameResult['hole_pair']['input'][9]}}" class=" hole_par_in" type="text" Name="gameResult[hole_pair][input][9]" /></td>
										<td class="numeric  pink"><input readonly="readonly" value="{{$gameResult['hole_pair']['input'][10]}}" class=" hole_par_in" type="text" Name="gameResult[hole_pair][input][10]" /></td>
										<td class="numeric  pink"><input readonly="readonly" value="{{$gameResult['hole_pair']['input'][11]}}" class=" hole_par_in" type="text" Name="gameResult[hole_pair][input][11]" /></td>
										<td class="numeric  pink"><input readonly="readonly" value="{{$gameResult['hole_pair']['input'][12]}}" class=" hole_par_in" type="text" Name="gameResult[hole_pair][input][12]" /></td>
										<td class="numeric  pink"><input readonly="readonly" value="{{$gameResult['hole_pair']['input'][13]}}" class=" hole_par_in" type="text" Name="gameResult[hole_pair][input][13]" /></td>
										<td class="numeric  pink"><input readonly="readonly" value="{{$gameResult['hole_pair']['input'][14]}}" class=" hole_par_in" type="text" Name="gameResult[hole_pair][input][14]" /></td>
										<td class="numeric  pink"><input readonly="readonly" value="{{$gameResult['hole_pair']['input'][15]}}" class=" hole_par_in" type="text" Name="gameResult[hole_pair][input][15]" /></td>
										<td class="numeric  pink"><input readonly="readonly" value="{{$gameResult['hole_pair']['input'][16]}}" class=" hole_par_in" type="text" Name="gameResult[hole_pair][input][16]" /></td>
										<td class="numeric  pink"><input readonly="readonly" value="{{$gameResult['hole_pair']['input'][17]}}" class=" hole_par_in" type="text" Name="gameResult[hole_pair][input][17]" /></td>
									...
									<tr>
										<td>SCORE</td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['score']['input'][0]}}" class=" score_out" type="text" Name="gameResult[score][input][0]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['score']['input'][1]}}" class=" score_out" type="text" Name="gameResult[score][input][1]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['score']['input'][2]}}" class=" score_out" type="text" Name="gameResult[score][input][2]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['score']['input'][3]}}" class=" score_out" type="text" Name="gameResult[score][input][3]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['score']['input'][4]}}" class=" score_out" type="text" Name="gameResult[score][input][4]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['score']['input'][5]}}" class=" score_out" type="text" Name="gameResult[score][input][5]" /></td>
										<td class="numeric "><input readonly="readonly" readonly="readonly" value="{{$gameResult['score']['input'][6]}}" class=" score_out" type="text" Name="gameResult[score][input][6]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['score']['input'][7]}}" class=" score_out" type="text" Name="gameResult[score][input][7]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['score']['input'][8]}}" class=" score_out" type="text" Name="gameResult[score][input][8]" /></td>

										<td><input value="{{$gameResult['score']['out_sum']}}" id="score_out_sum" readonly="readonly" Name="gameResult[score][out_sum]" /></td>

										<td class="numeric "><input readonly="readonly" value="{{$gameResult['score']['input'][9]}}" class=" score_in" type="text" Name="gameResult[score][input][9]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['score']['input'][10]}}" class=" score_in" type="text" Name="gameResult[score][input][10]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['score']['input'][11]}}" class=" score_in" type="text" Name="gameResult[score][input][11]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['score']['input'][12]}}" class=" score_in" type="text" Name="gameResult[score][input][12]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['score']['input'][13]}}" class=" score_in" type="text" Name="gameResult[score][input][13]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['score']['input'][14]}}" class=" score_in" type="text" Name="gameResult[score][input][14]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['score']['input'][15]}}" class=" score_in" type="text" Name="gameResult[score][input][15]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['score']['input'][16]}}" class=" score_in" type="text" Name="gameResult[score][input][16]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['score']['input'][17]}}" class=" score_in" type="text" Name="gameResult[score][input][17]" /></td>
									...
									<tr>
										<td>FIR</td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['fir']['input'][0]}}" class="fir_out" type="text" Name="gameResult[fir][input][0]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['fir']['input'][1]}}" class="fir_out" type="text" Name="gameResult[fir][input][1]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['fir']['input'][2]}}" class="fir_out" type="text" Name="gameResult[fir][input][2]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['fir']['input'][3]}}" class="fir_out" type="text" Name="gameResult[fir][input][3]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['fir']['input'][4]}}" class="fir_out" type="text" Name="gameResult[fir][input][4]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['fir']['input'][5]}}" class="fir_out" type="text" Name="gameResult[fir][input][5]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['fir']['input'][6]}}" class="fir_out" type="text" Name="gameResult[fir][input][6]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['fir']['input'][7]}}" class="fir_out" type="text" Name="gameResult[fir][input][7]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['fir']['input'][8]}}" class="fir_out" type="text" Name="gameResult[fir][input][8]" /></td>

										<td><input value="{{$gameResult['fir']['out_sum']}}" id ="fir_out_sum" readonly="readonly" Name="gameResult[fir][out_sum]" /></td>

										<td class="numeric "><input readonly="readonly" value="{{$gameResult['fir']['input'][9]}}" class="fir_in"  type="text" Name="gameResult[fir][input][9]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['fir']['input'][10]}}" class="fir_in" type="text" Name="gameResult[fir][input][10]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['fir']['input'][11]}}" class="fir_in"  type="text" Name="gameResult[fir][input][11]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['fir']['input'][12]}}" class="fir_in"  type="text" Name="gameResult[fir][input][12]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['fir']['input'][13]}}" class="fir_in"  type="text" Name="gameResult[fir][input][13]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['fir']['input'][14]}}" class="fir_in"  type="text" Name="gameResult[fir][input][14]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['fir']['input'][15]}}" class="fir_in"  type="text" Name="gameResult[fir][input][15]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['fir']['input'][16]}}" class="fir_in"  type="text" Name="gameResult[fir][input][16]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['fir']['input'][17]}}" class="fir_in"  type="text" Name="gameResult[fir][input][17]" /></td>
									...
									<tr>
										<td>GIR</td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['gir']['input'][0]}}" class="gir_out" type="text" Name="gameResult[gir][input][0]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['gir']['input'][1]}}" class="gir_out" type="text" Name="gameResult[gir][input][1]" /></td>

										<td class="numeric "><input readonly="readonly" value="{{$gameResult['gir']['input'][2]}}" class="gir_out" type="text" Name="gameResult[gir][input][2]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['gir']['input'][3]}}" class="gir_out" type="text" Name="gameResult[gir][input][3]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['gir']['input'][4]}}" class="gir_out" type="text" Name="gameResult[gir][input][4]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['gir']['input'][5]}}" class="gir_out" type="text" Name="gameResult[gir][input][5]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['gir']['input'][6]}}" class="gir_out" type="text" Name="gameResult[gir][input][6]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['gir']['input'][7]}}" class="gir_out" type="text" Name="gameResult[gir][input][7]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['gir']['input'][8]}}" class="gir_out" type="text" Name="gameResult[gir][input][8]" /></td>

										<td><input value="{{$gameResult['gir']['out_sum']}}" id ="gir_out_sum" readonly="readonly" Name="gameResult[gir][out_sum]" /></td>

										
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['gir']['input'][9]}}" class="gir_in"  type="text" Name="gameResult[gir][input][9]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['gir']['input'][10]}}" class="gir_in" type="text" Name="gameResult[gir][input][10]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['gir']['input'][11]}}" class="gir_in"  type="text" Name="gameResult[gir][input][11]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['gir']['input'][12]}}" class="gir_in"  type="text" Name="gameResult[gir][input][12]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['gir']['input'][13]}}" class="gir_in"  type="text" Name="gameResult[gir][input][13]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['gir']['input'][14]}}" class="gir_in"  type="text" Name="gameResult[gir][input][14]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['gir']['input'][15]}}" class="gir_in"  type="text" Name="gameResult[gir][input][15]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['gir']['input'][16]}}" class="gir_in"  type="text" Name="gameResult[gir][input][16]" /></td>
										<td class="numeric"><input readonly="readonly" value="{{$gameResult['gir']['input'][17]}}" class="gir_in"  type="text" Name="gameResult[gir][input][17]" /></td>
									...
									<tr>
										<td>PUTT 1</td>
										<td class="numeric "><input readonly="readonly" readonly="readonly" value="{{$gameResult['putt_1']['input'][0]}}" class="putt_1_out" type="text" Name="gameResult[putt_1][input][0]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_1']['input'][1]}}" class="putt_1_out" type="text" Name="gameResult[putt_1][input][1]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_1']['input'][2]}}" class="putt_1_out" type="text" Name="gameResult[putt_1][input][2]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_1']['input'][3]}}" class="putt_1_out" type="text" Name="gameResult[putt_1][input][3]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_1']['input'][4]}}" class="putt_1_out" type="text" Name="gameResult[putt_1][input][4]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_1']['input'][5]}}" class="putt_1_out" type="text" Name="gameResult[putt_1][input][5]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_1']['input'][6]}}" class="putt_1_out" type="text" Name="gameResult[putt_1][input][6]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_1']['input'][7]}}" class="putt_1_out" type="text" Name="gameResult[putt_1][input][7]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_1']['input'][8]}}" class="putt_1_out" type="text" Name="gameResult[putt_1][input][8]" /></td>
										...
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_1']['input'][9]}}" class="putt_1_in"  type="text" Name="gameResult[putt_1][input][9]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_1']['input'][10]}}" class="putt_1_in" type="text" Name="gameResult[putt_1][input][10]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_1']['input'][11]}}" class="putt_1_in"  type="text" Name="gameResult[putt_1][input][11]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_1']['input'][12]}}" class="putt_1_in"  type="text" Name="gameResult[putt_1][input][12]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_1']['input'][13]}}" class="putt_1_in"  type="text" Name="gameResult[putt_1][input][13]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_1']['input'][14]}}" class="putt_1_in"  type="text" Name="gameResult[putt_1][input][14]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_1']['input'][15]}}" class="putt_1_in"  type="text" Name="gameResult[putt_1][input][15]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_1']['input'][16]}}" class="putt_1_in"  type="text" Name="gameResult[putt_1][input][16]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_1']['input'][17]}}" class="putt_1_in"  type="text" Name="gameResult[putt_1][input][17]" /></td>
									...
									<tr>
										<td>PUTT 2</td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_2']['input'][0]}}" class="putt_2_out" type="text" Name="gameResult[putt_2][input][0]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_2']['input'][1]}}" class="putt_2_out" type="text" Name="gameResult[putt_2][input][1]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_2']['input'][2]}}" class="putt_2_out" type="text" Name="gameResult[putt_2][input][2]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_2']['input'][3]}}" class="putt_2_out" type="text" Name="gameResult[putt_2][input][3]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_2']['input'][4]}}" class="putt_2_out" type="text" Name="gameResult[putt_2][input][4]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_2']['input'][5]}}" class="putt_2_out" type="text" Name="gameResult[putt_2][input][5]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_2']['input'][6]}}" class="putt_2_out" type="text" Name="gameResult[putt_2][input][6]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_2']['input'][7]}}" class="putt_2_out" type="text" Name="gameResult[putt_2][input][7]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_2']['input'][8]}}" class="putt_2_out" type="text" Name="gameResult[putt_2][input][8]" /></td>

										<td><input value="{{$gameResult['putt_2']['out_sum']}}" id ="putt_2_out_sum" readonly="readonly" Name="gameResult[putt_2][out_sum]" /></td>

										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_2']['input'][10]}}" class="putt_2_in" type="text" Name="gameResult[putt_2][input][10]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_2']['input'][11]}}" class="putt_2_in"  type="text" Name="gameResult[putt_2][input][11]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_2']['input'][12]}}" class="putt_2_in"  type="text" Name="gameResult[putt_2][input][12]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_2']['input'][13]}}" class="putt_2_in"  type="text" Name="gameResult[putt_2][input][13]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_2']['input'][14]}}" class="putt_2_in"  type="text" Name="gameResult[putt_2][input][14]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_2']['input'][15]}}" class="putt_2_in"  type="text" Name="gameResult[putt_2][input][15]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_2']['input'][16]}}" class="putt_2_in"  type="text" Name="gameResult[putt_2][input][16]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_2']['input'][17]}}" class="putt_2_in"  type="text" Name="gameResult[putt_2][input][17]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_2']['input'][18]}}" class="putt_2_in"  type="text" Name="gameResult[putt_2][input][18]" /></td>
									...
									<tr>
										<td>PUTT 3</td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_3']['input'][0]}}" class="putt_3_out" type="text" Name="gameResult[putt_3][input][0]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_3']['input'][1]}}" class="putt_3_out" type="text" Name="gameResult[putt_3][input][1]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_3']['input'][2]}}" class="putt_3_out" type="text" Name="gameResult[putt_3][input][2]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_3']['input'][3]}}" class="putt_3_out" type="text" Name="gameResult[putt_3][input][3]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_3']['input'][4]}}" class="putt_3_out" type="text" Name="gameResult[putt_3][input][4]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_3']['input'][5]}}" class="putt_3_out" type="text" Name="gameResult[putt_3][input][5]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_3']['input'][6]}}" class="putt_3_out" type="text" Name="gameResult[putt_3][input][6]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_3']['input'][7]}}" class="putt_3_out" type="text" Name="gameResult[putt_3][input][7]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_3']['input'][8]}}" class="putt_3_out" type="text" Name="gameResult[putt_3][input][8]" /></td>

										<td><input value="{{$gameResult['putt_3']['out_sum']}}" id ="putt_3_out_sum" readonly="readonly" Name="gameResult[putt_3][out_sum]" /></td>

										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_3']['input'][9]}}" class="putt_3_in"  type="text" Name="gameResult[putt_3][input][9]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_3']['input'][10]}}" class="putt_3_in"  type="text" Name="gameResult[putt_3][input][10]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_3']['input'][11]}}" class="putt_3_in"  type="text" Name="gameResult[putt_3][input][11]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_3']['input'][12]}}" class="putt_3_in"  type="text" Name="gameResult[putt_3][input][12]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_3']['input'][13]}}" class="putt_3_in"  type="text" Name="gameResult[putt_3][input][13]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_3']['input'][14]}}" class="putt_3_in"  type="text" Name="gameResult[putt_3][input][14]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_3']['input'][15]}}" class="putt_3_in"  type="text" Name="gameResult[putt_3][input][15]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_3']['input'][16]}}" class="putt_3_in"  type="text" Name="gameResult[putt_3][input][16]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult['putt_3']['input'][17]}}" class="putt_3_in"  type="text" Name="gameResult[putt_3][input][17]" /></td>
									...
									<tr>
										<td>PUTT OPP &lt;5</td>
										<td class="numeric ash"><input value="{{$gameResult['putt_opp_5']['input'][0]}}" class="putt_opp_5_out" type="text" Name="gameResult[putt_opp_5][input][0]" id='putt_opp_5_out_0' readonly="readonly" /></td>

										<td class="numeric ash"><input value="{{$gameResult['putt_opp_5']['input'][1]}}" class="putt_opp_5_out" type="text" Name="gameResult[putt_opp_5][input][1]" id='putt_opp_5_out_1' readonly="readonly"/></td>
										<td class="numeric ash"><input value="{{$gameResult['putt_opp_5']['input'][2]}}" class="putt_opp_5_out" type="text" Name="gameResult[putt_opp_5][input][2]" id='putt_opp_5_out_2' readonly="readonly"/></td>
										<td class="numeric ash"><input value="{{$gameResult['putt_opp_5']['input'][3]}}" class="putt_opp_5_out" type="text" Name="gameResult[putt_opp_5][input][3]" id='putt_opp_5_out_3' readonly="readonly"/></td>
										<td class="numeric ash"><input value="{{$gameResult['putt_opp_5']['input'][4]}}" class="putt_opp_5_out" type="text" Name="gameResult[putt_opp_5][input][4]" id='putt_opp_5_out_4' readonly="readonly"/></td>
										<td class="numeric ash"><input value="{{$gameResult['putt_opp_5']['input'][5]}}" class="putt_opp_5_out" type="text" Name="gameResult[putt_opp_5][input][5]" id='putt_opp_5_out_5' readonly="readonly"/></td>
										<td class="numeric ash"><input value="{{$gameResult['putt_opp_5']['input'][6]}}" class="putt_opp_5_out" type="text" Name="gameResult[putt_opp_5][input][6]" id='putt_opp_5_out_6' readonly="readonly"/></td>
										<td class="numeric ash"><input value="{{$gameResult['putt_opp_5']['input'][7]}}" class="putt_opp_5_out" type="text" Name="gameResult[putt_opp_5][input][7]" id='putt_opp_5_out_7' readonly="readonly"/></td>
										<td class="numeric ash"><input value="{{$gameResult['putt_opp_5']['input'][8]}}" class="putt_opp_5_out" type="text" Name="gameResult[putt_opp_5][input][8]" id='putt_opp_5_out_8' readonly="readonly"/></td>
										...
										<td class="numeric ash"><input value="{{$gameResult['putt_opp_5']['input'][10]}}" class="putt_opp_5_in" type="text" Name="gameResult[putt_opp_5][input][10]" id='putt_opp_5_in_0' readonly="readonly"/></td>
										<td class="numeric ash"><input value="{{$gameResult['putt_opp_5']['input'][11]}}" class="putt_opp_5_in"  type="text" Name="gameResult[putt_opp_5][input][11]" id='putt_opp_5_in_1' readonly="readonly"/></td>
										<td class="numeric ash"><input value="{{$gameResult['putt_opp_5']['input'][12]}}" class="putt_opp_5_in"  type="text" Name="gameResult[putt_opp_5][input][12]" id='putt_opp_5_in_2' readonly="readonly"/></td>
										<td class="numeric ash"><input value="{{$gameResult['putt_opp_5']['input'][13]}}" class="putt_opp_5_in"  type="text" Name="gameResult[putt_opp_5][input][13]" id='putt_opp_5_in_3' readonly="readonly"/></td>
										<td class="numeric ash"><input value="{{$gameResult['putt_opp_5']['input'][14]}}" class="putt_opp_5_in"  type="text" Name="gameResult[putt_opp_5][input][14]" id='putt_opp_5_in_4' readonly="readonly"/></td>
										<td class="numeric ash"><input value="{{$gameResult['putt_opp_5']['input'][15]}}" class="putt_opp_5_in"  type="text" Name="gameResult[putt_opp_5][input][15]" id='putt_opp_5_in_5' readonly="readonly"/></td>
										<td class="numeric ash"><input value="{{$gameResult['putt_opp_5']['input'][16]}}" class="putt_opp_5_in"  type="text" Name="gameResult[putt_opp_5][input][16]" id='putt_opp_5_in_6' readonly="readonly"/></td>
										<td class="numeric ash"><input value="{{$gameResult['putt_opp_5']['input'][17]}}" class="putt_opp_5_in"  type="text" Name="gameResult[putt_opp_5][input][17]" id='putt_opp_5_in_7' readonly="readonly"/></td>
										<td class="numeric ash"><input value="{{$gameResult['putt_opp_5']['input'][18]}}" class="putt_opp_5_in"  type="text" Name="gameResult[putt_opp_5][input][18]" id='putt_opp_5_in_8' readonly="readonly"/></td>
									...
									<tr>
										<td>PUTT MAKE  &lt;5</td>
										<td class="numeric ash"><input value="{{$gameResult["putt_make_5"]["input"][0]}}" class="putt_make_5_out" type="text" Name="gameResult[putt_make_5][input][0]" id='putt_make_5_out_0' readonly="readonly"/></td>
										<td class="numeric ash"><input value="{{$gameResult["putt_make_5"]["input"][1]}}" class="putt_make_5_out" type="text" Name="gameResult[putt_make_5][input][1]" id='putt_make_5_out_1' readonly="readonly"/></td>
										<td class="numeric ash"><input value="{{$gameResult["putt_make_5"]["input"][2]}}" class="putt_make_5_out" type="text" Name="gameResult[putt_make_5][input][2]" id='putt_make_5_out_2' readonly="readonly"/></td>
										<td class="numeric ash"><input value="{{$gameResult["putt_make_5"]["input"][3]}}" class="putt_make_5_out" type="text" Name="gameResult[putt_make_5][input][3]" id='putt_make_5_out_3' readonly="readonly"/></td>
										<td class="numeric ash"><input value="{{$gameResult["putt_make_5"]["input"][4]}}" class="putt_make_5_out" type="text" Name="gameResult[putt_make_5][input][4]" id='putt_make_5_out_4' readonly="readonly"/></td>
										<td class="numeric ash"><input value="{{$gameResult["putt_make_5"]["input"][5]}}" class="putt_make_5_out" type="text" Name="gameResult[putt_make_5][input][5]" id='putt_make_5_out_5' readonly="readonly"/></td>
										<td class="numeric ash"><input value="{{$gameResult["putt_make_5"]["input"][6]}}" class="putt_make_5_out" type="text" Name="gameResult[putt_make_5][input][6]" id='putt_make_5_out_6' readonly="readonly"/></td>
										<td class="numeric ash"><input value="{{$gameResult["putt_make_5"]["input"][7]}}" class="putt_make_5_out" type="text" Name="gameResult[putt_make_5][input][7]" id='putt_make_5_out_7' readonly="readonly"/></td>
										<td class="numeric ash"><input value="{{$gameResult["putt_make_5"]["input"][8]}}" class="putt_make_5_out" type="text" Name="gameResult[putt_make_5][input][8]" id='putt_make_5_out_8' readonly="readonly"/></td>
										...
										<td class="numeric ash"><input value="{{$gameResult["putt_make_5"]["input"][9]}}" class="putt_make_5_in" type="text" Name="gameResult[putt_make_5][input][9]" id='putt_make_5_in_0' readonly="readonly"/></td>
										<td class="numeric ash"><input value="{{$gameResult["putt_make_5"]["input"][10]}}" class="putt_make_5_in" type="text" Name="gameResult[putt_make_5][input][10]" id='putt_make_5_in_1' readonly="readonly"/></td>
										<td class="numeric ash"><input value="{{$gameResult["putt_make_5"]["input"][11]}}" class="putt_make_5_in"  type="text" Name="gameResult[putt_make_5][input][11]" id='putt_make_5_in_2' readonly="readonly"/></td>
										<td class="numeric ash"><input value="{{$gameResult["putt_make_5"]["input"][12]}}" class="putt_make_5_in"  type="text" Name="gameResult[putt_make_5][input][12]" id='putt_make_5_in_3' readonly="readonly"/></td>
										<td class="numeric ash"><input value="{{$gameResult["putt_make_5"]["input"][13]}}" class="putt_make_5_in"  type="text" Name="gameResult[putt_make_5][input][13]" id='putt_make_5_in_4' readonly="readonly"/></td>
										<td class="numeric ash"><input value="{{$gameResult["putt_make_5"]["input"][14]}}" class="putt_make_5_in"  type="text" Name="gameResult[putt_make_5][input][14]" id='putt_make_5_in_5' readonly="readonly"/></td>
										<td class="numeric ash"><input value="{{$gameResult["putt_make_5"]["input"][15]}}" class="putt_make_5_in"  type="text" Name="gameResult[putt_make_5][input][15]" id='putt_make_5_in_6' readonly="readonly"/></td>
										<td class="numeric ash"><input value="{{$gameResult["putt_make_5"]["input"][16]}}" class="putt_make_5_in"  type="text" Name="gameResult[putt_make_5][input][16]" id='putt_make_5_in_7' readonly="readonly"/></td>
										<td class="numeric ash"><input value="{{$gameResult["putt_make_5"]["input"][17]}}" class="putt_make_5_in"  type="text" Name="gameResult[putt_make_5][input][17]" id='putt_make_5_in_8' readonly="readonly"/></td>
									...
									<tr>
										<td>SAND OPP</td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult["sand_opp"]["input"][0]}}" class="sand_opp_out" type="text" Name="gameResult[sand_opp][input][0]" id="sand_opp_out_0" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult["sand_opp"]["input"][1]}}" class="sand_opp_out" type="text" Name="gameResult[sand_opp][input][1]" id="sand_opp_out_1" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult["sand_opp"]["input"][2]}}" class="sand_opp_out" type="text" Name="gameResult[sand_opp][input][2]" id="sand_opp_out_2" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult["sand_opp"]["input"][3]}}" class="sand_opp_out" type="text" Name="gameResult[sand_opp][input][3]" id="sand_opp_out_3" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult["sand_opp"]["input"][4]}}" class="sand_opp_out" type="text" Name="gameResult[sand_opp][input][4]" id="sand_opp_out_4" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult["sand_opp"]["input"][5]}}" class="sand_opp_out" type="text" Name="gameResult[sand_opp][input][5]" id="sand_opp_out_5" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult["sand_opp"]["input"][6]}}" class="sand_opp_out" type="text" Name="gameResult[sand_opp][input][6]" id="sand_opp_out_6" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult["sand_opp"]["input"][7]}}" class="sand_opp_out" type="text" Name="gameResult[sand_opp][input][7]" id="sand_opp_out_7" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult["sand_opp"]["input"][8]}}" class="sand_opp_out" type="text" Name="gameResult[sand_opp][input][8]" id="sand_opp_out_8" /></td>

										<td><input value="{{$gameResult["sand_opp"]["out_sum"]}}" id ="sand_opp_out_sum" readonly="readonly" Name="gameResult[sand_opp][out_sum]" /></td>

										<td class="numeric "><input readonly="readonly" value="{{$gameResult["sand_opp"]["input"][9]}}" class="sand_opp_in"  type="text" id="sand_opp_in_0" Name="gameResult[sand_opp][input][9]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult["sand_opp"]["input"][10]}}" class="sand_opp_in"  type="text" id="sand_opp_in_1" Name="gameResult[sand_opp][input][10]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult["sand_opp"]["input"][11]}}" class="sand_opp_in"  type="text" id="sand_opp_in_2" Name="gameResult[sand_opp][input][11]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult["sand_opp"]["input"][12]}}" class="sand_opp_in"  type="text" id="sand_opp_in_3" Name="gameResult[sand_opp][input][12]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult["sand_opp"]["input"][13]}}" class="sand_opp_in"  type="text" id="sand_opp_in_4" Name="gameResult[sand_opp][input][13]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult["sand_opp"]["input"][14]}}" class="sand_opp_in"  type="text" id="sand_opp_in_5" Name="gameResult[sand_opp][input][14]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult["sand_opp"]["input"][15]}}" class="sand_opp_in"  type="text" id="sand_opp_in_6" Name="gameResult[sand_opp][input][15]" /></td>
										<td class="numeric"><input readonly="readonly" value="{{$gameResult["sand_opp"]["input"][16]}}" class="sand_opp_in"  type="text" id="sand_opp_in_7" Name="gameResult[sand_opp][input][16]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult["sand_opp"]["input"][17]}}" class="sand_opp_in"  type="text" id="sand_opp_in_8" Name="gameResult[sand_opp][input][17]" /></td>
									...
									<tr>
										<td>PENALTIES</td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult["penalties"]["input"][0]}}" class="penalties_out" type="text" Name="gameResult[penalties][input][0]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult["penalties"]["input"][1]}}" class="penalties_out" type="text" Name="gameResult[penalties][input][1]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult["penalties"]["input"][2]}}" class="penalties_out" type="text" Name="gameResult[penalties][input][2]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult["penalties"]["input"][3]}}" class="penalties_out" type="text" Name="gameResult[penalties][input][3]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult["penalties"]["input"][4]}}" class="penalties_out" type="text" Name="gameResult[penalties][input][4]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult["penalties"]["input"][5]}}" class="penalties_out" type="text" Name="gameResult[penalties][input][5]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult["penalties"]["input"][6]}}" class="penalties_out" type="text" Name="gameResult[penalties][input][6]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult["penalties"]["input"][7]}}" class="penalties_out" type="text" Name="gameResult[penalties][input][7]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult["penalties"]["input"][8]}}" class="penalties_out" type="text" Name="gameResult[penalties][input][8]" /></td>

										<td><input value="{{$gameResult["penalties"]["out_sum"]}}" id ="penalties_out_sum" readonly="readonly" Name="gameResult[penalties][out_sum]" /></td>

										<td class="numeric "><input readonly="readonly" value="{{$gameResult["penalties"]["input"][9]}}" class="penalties_in"  type="text" Name="gameResult[penalties][input][9]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult["penalties"]["input"][10]}}" class="penalties_in" type="text" Name="gameResult[penalties][input][10]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult["penalties"]["input"][11]}}" class="penalties_in"  type="text" Name="gameResult[penalties][input][11]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult["penalties"]["input"][12]}}" class="penalties_in"  type="text" Name="gameResult[penalties][input][12]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult["penalties"]["input"][13]}}" class="penalties_in"  type="text" Name="gameResult[penalties][input][13]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult["penalties"]["input"][14]}}" class="penalties_in"  type="text" Name="gameResult[penalties][input][14]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult["penalties"]["input"][15]}}" class="penalties_in"  type="text" Name="gameResult[penalties][input][15]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult["penalties"]["input"][16]}}" class="penalties_in"  type="text" Name="gameResult[penalties][input][16]" /></td>
										<td class="numeric "><input readonly="readonly" value="{{$gameResult["penalties"]["input"][17]}}" class="penalties_in"  type="text" Name="gameResult[penalties][input][17]" /></td>
									...
									<tr>
										<td>PAR5STROKES</td>
										<td class="numeric ash"><input value="{{$gameResult["par5strokes"]["input"][0]}}" id="par5strokes_out" readonly="readonly"  type="text" Name="gameResult[par5strokes][input][0]" /></td>
										<td class="black"></td>
										<td class="black"></td>
										<td class="black"></td>
										<td class="black"></td>
										...
										<td class="numeric ash"><input value="{{$gameResult["par5strokes"]["input"][1]}}"  id="par5strokes_in" readonly="readonly" type="text" Name="gameResult[par5strokes][input][1]" /></td>
										<td class="black"></td>
										<td class="black"></td>
										<td class="black"></td>
										<td class="black"></td>
